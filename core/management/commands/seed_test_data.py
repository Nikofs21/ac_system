...
from access.models import Role, Permission
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('  Rol supervisor OK')
        ...
        # Jornada laboral L-J 08:00-18:00, V 08:00-17:00
        jornada = [
            (0, '08:00', '18:00', '13:00', '14:00'),  # Lunes
            (1, '08:00', '18:00', '13:00', '14:00'),  # Martes
            (2, '08:00', '18:00', '13:00', '14:00'),  # Miercoles
            (3, '08:00', '18:00', '13:00', '14:00'),  # Jueves
            (4, '08:00', '17:00', '13:00', '14:00'),  # Viernes
        ]
        ...
        if created:
            supervisor.set_password('prueba1234')
            supervisor.save()
        ...
        self.stdout.write(f'  Supervisor: supervisor@prueba.cl / prueba1234')

        # 5. CATEGORIAS DE RECURSO
        cat_person, _ = ResourceCategory.objects.get_or_create(
            code='PERSON',
            defaults={'name': 'Persona', 'resource_type': 'PERSON', 'is_active': True}
        )
        ...
        # 8. ETAPAS Y PARTIDAS (desde datos reales B200)
        etapas_data = [
            {
                'code': 'TERMINACIONES',
                'name': 'Terminaciones',
        ...
        self.stdout.write(self.style.SUCCESS('Supervisor: supervisor@prueba.cl / prueba1234'))
